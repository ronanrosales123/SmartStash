                          ...
                          bool? confirmCancel = await showDialog<bool>(
                            ...
                            builder: (BuildContext context) {
                              return AlertDialog(
                                ...
                                content: Text('Do you really want to cancel this transaction?'),
                                actions: <Widget>[
                                  TextButton(
                                    child: Text('Yes'),
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          if (isCOD && !isLockerOccupied)
                            ElevatedButton(
                              onPressed: () => depositMoney(context, lockerNumber, doc.id),
                          ...
                          SizedBox(width: 8),
                          ElevatedButton(
                            onPressed: isLockerOccupied ? () => claimPackage(context, doc.id, lockerNumber) : null,
                            child: Text('Claim'),
                            style: ElevatedButton.styleFrom(
                              primary: isLockerOccupied ? Colors.blue : Colors.grey,
                            ),
                          ),
                        ],
                      ),
        ...
        actions: <Widget>[
          TextButton(
            ...
            onPressed: () async {
              ...
              await FirebaseFirestore.instance.collection('registrations').doc(docId).delete();
